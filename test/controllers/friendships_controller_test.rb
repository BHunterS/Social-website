...
class FriendshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friendship" do
    assert_difference("Friendship.count") do
      post friendships_url, params: { friendship: { profile_accept: @friendship.profile_accept, profile_request: @friendship.profile_request } }
    end
  ...
  test "should update friendship" do
    patch friendship_url(@friendship), params: { friendship: { profile_accept: @friendship.profile_accept, profile_request: @friendship.profile_request } }
